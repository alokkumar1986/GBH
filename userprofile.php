...
<html lang="en" dir="ltr">
		...
		<!-- Title -->
		<title>Gharabhada | User Profile</title>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-12" id="container">
										...
										<div class="row usedetel" id='iamdiv'>
											<div class="col-md-2">
												<label class="form-label" id="iam">Full Name</label>
											</div>
											<div class="col-md-4">
												<input type="text" class="form-control text-center" id="owner"	name="owner" readonly value="Owner">
											</div>
										</div>
										</div>
										...
										<div class="row usedetel" id='iamdiv'>
											<div class="col-md-2">
												<label class="form-label" id="iam">Mobile No</label>
											</div>
											<div class="col-md-4">
												<input type="text" class="form-control text-center" id="owner"	name="owner" readonly value="Owner">
											</div>
										...
										<div class="row usedetel" id='iamdiv'>
											<div class="col-md-2">
												<label class="form-label" id="iam">Email ID</label>
											</div>
											<div class="col-md-4">
												<input type="text" class="form-control text-center" id="owner"	name="owner" readonly value="Owner">
											</div>
